...
namespace HeatMap
{
    public class HeatMapImage
    {
        ...
        private void CreateColorMap()
        {
            ...
            colorBlend.Positions = new float[8] { 0.0f, 0.01f, 0.05f, 0.07f, 0.10f, 0.2f, 0.4f, 1.0f };
        ...
        private unsafe void ProcessUsingLockbitsAndUnsafe(Bitmap processedBitmap)
        {
            ...
            int bytesPerPixel = System.Drawing.Bitmap.GetPixelFormatSize(processedBitmap.PixelFormat) / 32;
